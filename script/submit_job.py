...
try:
    ...
    for pathvalue in filepath:
        ...
        cmd = "bsub -q 8nh -e %s -o %s \'cd /afs/cern.ch/work/j/jishi/private/experiment/googleclusterdata/ && python /afs/cern.ch/work/j/jishi/private/experiment/googleclusterdata/script/csv_transform.py %s %s > %s 2>&1\'" % (logpath + '/' +jobname + '.elog', logpath + '/' +jobname + '.olog', pathvalue, resultpath, logpath + '/' +jobname + '.log')
        #print cmd
        os.system(cmd)
