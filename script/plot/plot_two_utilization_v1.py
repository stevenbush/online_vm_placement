...
for inputfile in host_path:
    ...
    for i in range(len(ORA_result_host_list)):
        ORA_result_host_list[i] = result_maxload_list[i] / ORA_result_host_list[i]
...
for inputfile in host_path:
    ...
    for i in range(len(ARP_result_host_list)):
        ARP_result_host_list[i] = result_maxload_list[i] / ARP_result_host_list[i]
...
for inputfile in host_path:
    ...
    for i in range(len(ARP_result_host_list)):
        ROBP_result_host_list[i] = result_maxload_list[i] / ROBP_result_host_list[i]
     
fig, ax = plt.subplots()
     
# plt.plot(result_maxload_list, 'k', label='Actual Workload Demand')
