...
if len(sys.argv) < 3:
    ...
    print 'python generate_workload.py input_job_file output_path'
    sys.exit()
...
try:
    ...
    cpu_writer = csv.writer(open(outpath + 'raw_workload-cpu-' + file_name, 'wb'))
    mem_writer = csv.writer(open(outpath + 'raw_workload-mem-' + file_name, 'wb'))
